...
const COMMON_MOTIFS = [
  {
    id: "silent-triangle",
    name: "SILENT TRIANGLE HOVER",
    accent: "#39ff14",
    prevalence: 1247,
    blurb: "Large black triangular craft hovering silently with extreme animal reactions and instant acceleration.",
    ...
    why: "These phrases point in similar directions in the 1024-d space even when wording differs. 'No sound' + 'triangle' + 'hover' + 'slow' form a tight semantic neighborhood. Not keyword match — meaning match.",
    quotes: [
      ...
      { id: 150913, sim: 0.89, text: "Triangle shape craft hovering silently very close to roof. Initially all black then glowed red on the underside and silently moved away southwards." },
    ],
  },
  {
    id: "physical-scars",
    name: "PHYSICAL MARKS / SCARS",
    accent: "#ff3ea5",
    prevalence: 1644,
    blurb: "New physical scars, burns, or implants appearing after close encounter or missing time.",
    sim: [0.92, 0.9, 0.87, 0.86],
    bitmap: [
      "...GGGGG...",
      "..G.....G..",
      "..G.PPP.G..",
    ...
    why: "The light enrichment tag 'physical mark / implant / scar' fires often, and the embedding pulls together varied descriptions of new unexplained marks on the body. High count because the signal is both frequent and semantically coherent.",
    quotes: [
      { id: 1982, sim: 0.92, text: "I pealed away the lose skin and noticed a small scar that had not been there before." },
      { id: 172563, sim: 0.9, text: "Both arms were still very red and sore but the pain and redness did decrease. Open sores that had scabbed over." },
      { id: 119406, sim: 0.87, text: "Down like 4 layers of my skin, as if someone had literally punched a hole with a paper punch out of it." },
    ],
  },
  {
    id: "gray-exam",
    name: "GRAY BEINGS / TABLE EXAM",
    accent: "#22e0ff",
    prevalence: 892,
    blurb: "Small gray beings with large black eyes performing medical examinations on a table with missing time.",
    ...
    why: "High cosine to the gray-medical-exam benchmark prototype. 'Small grey alien next to me and bright red light', 'felt examined', 'on a table' etc. cluster tightly even without the exact canonical words every time.",
    quotes: [
      ...
      { id: 147572, sim: 0.9, text: "Small grey alien next to me and bright red light glowing behind the door. I felt examined." },
    ],
  },
  {
    id: "telepathic",
    ...
    accent: "#ffe23d",
    prevalence: 1483,
    blurb: "Direct mind-to-mind messages about 'the project', genetics, or warnings from beings.",
    sim: [0.93, 0.91, 0.89, 0.87],
    bitmap: [
      "Y..YYYYY..Y",
      ".Y.YYYYY.Y.",
      "..YYDDDYY..",
    ...
    why: "The light tag 'telepathic or direct mind communication' is one of the most frequent. The embedding recognizes the shared 'message received without sound / inside the head / knowing things you shouldn't' pattern across wildly varied stories.",
    quotes: [
      { id: 155767, sim: 0.93, text: "I have been awaiting an understanding of the purpose for that encounter. I had genius quotient at such a young age, and these beings..." },
      { id: 88900, sim: 0.91, text: "The Greatest Conspiracy on Earth Chapter 2 Tensions have escalated in the cell that the United States government has created around me..." },
    ],
  },
  {
    id: "beam-lift",
    name: "BEAM OF LIGHT / LIFT",
    accent: "#39ff14",
    prevalence: 723,
    blurb: "Beam of light scanning subject or area, or subject placed on table and examined or probed.",
    ...
    why: "High similarity to the 'disk beam livestock' benchmark + frequent 'beam of light scanned' / 'table/exam' tags. The light as active agent or transport is a strong recurring direction in the space.",
    quotes: [
